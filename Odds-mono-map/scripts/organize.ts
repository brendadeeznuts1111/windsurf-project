...
import { VaultFile, VaultConfig } from '../src/types/vault-types.js';
...
class VaultOrganizer {
    ...
    async organizeAll(): Promise<OrganizationResult> {
        ...
        // Get all markdown files not in proper locations
        ...
        console.log(chalk.gray(`Found ${files.length} files to organize`));
