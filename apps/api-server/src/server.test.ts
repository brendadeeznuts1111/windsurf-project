...
describe("Windsurf API Server", () => {
  ...
  it("should have proper package.json", () => {
    ...
    expect(pkg.name).toBe("windsurf-api-server");
  ...
  it("should have README documentation", async () => {
    ...
    expect(readme).toContain("Windsurf REST API Server");
    expect(readme).toContain("Enterprise-grade REST API");
